...
namespace LCT.Infrastructure.Migrations
{
    ...
    [Migration("20220413055441_draw team")]
    partial class drawteam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LCT.Core.Entites.Tournaments.Entities.DrawTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LCT.Core.Entites.Tournaments.Entities.Player", b =>
                {
                    ...
                    b.HasIndex("Name", "Surname", "TournamentId")
                        .IsUnique()
                        .HasFilter("[TournamentId] IS NOT NULL");
